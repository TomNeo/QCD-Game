...
public class GdxAppodeal {
    ...
    public static void initialize(String appKey, int adType, boolean hasConsent) {
        getInstance().initialize(appKey, adType, hasConsent);
    }
    ...
    public static void setSegmentFilter(String s, boolean b){
        getInstance().setSegmentFilter(s, b);
    }

    public static void setSegmentFilter(String s, double v){
        getInstance().setSegmentFilter(s, v);
    }

    public static void setSegmentFilter(String s, int i){
        getInstance().setSegmentFilter(s, i);
    }

    public static void setSegmentFilter(String s1, String s2){
        getInstance().setSegmentFilter(s1, s2);
    }
