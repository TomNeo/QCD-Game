...
public class AndroidGdxAppodeal implements AppodealInterface, BannerCallbacks, InterstitialCallbacks,
        RewardedVideoCallbacks, NonSkippableVideoCallbacks, PermissionsHelper.AppodealPermissionCallbacks {
    ...
    @Override
    public void initialize(String appId, int type, boolean hasConsent) {
        Appodeal.setFramework("gdx", GdxAppodeal.getPluginVersion());
        Appodeal.initialize(activity, appId, type, hasConsent);
    }
...
//    public void onNonSkippableVideoLoaded() { nonSkippableVideoListener.onNonSkippableVideoLoaded(); }
    ...
    public void onNonSkippableVideoLoaded(boolean b) {
        nonSkippableVideoListener.onNonSkippableVideoLoaded(b);
    }
    ...
    @Override
    public void onNonSkippableVideoClosed(boolean isFinished) { nonSkippableVideoListener.onNonSkippableVideoClosed(isFinished); }
...
//    }
    ...
    public void onRewardedVideoLoaded(boolean b) {
        rewardedVideoListener.onRewardedVideoLoaded(b);
    }
    ...
    public void onRewardedVideoFinished(double v, String s) {
        rewardedVideoListener.onRewardedVideoFinished(v, s);
        Gdx.app.debug("GDXAppodeal", "Reward from appodeal:" + v+" "+s);
    }
...
//    }
    ...
    @Override
    public void setSegmentFilter(String s, boolean b) {
        Appodeal.setSegmentFilter(s, b);
    }

    @Override
    public void setSegmentFilter(String s, int i) {
        Appodeal.setSegmentFilter(s, i);
    }

    @Override
    public void setSegmentFilter(String s, double v) {
        Appodeal.setSegmentFilter(s, v);
    }

    @Override
    public void setSegmentFilter(String s1, String s2) {
        Appodeal.setSegmentFilter(s1, s2);
    }
    ...
    public RewardParameters getRewardParameters() {
        Pair<Double, String> p = Appodeal.getRewardParameters();
    ...
    public RewardParameters getRewardParameters(String placement) {
        Pair<Double, String> p = Appodeal.getRewardParameters(placement);
        RewardParameters ret = new RewardParameters();
        ret.amount = p.first;
        ret.currencyName = p.second;
        return ret;
